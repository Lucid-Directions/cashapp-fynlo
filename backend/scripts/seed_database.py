...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Seed Fynlo POS database with production-like data"
    )
    parser.add_argument(
        "--force", action="store_true", help="Force reseed even if data exists"
    )
    parser.add_argument(
        "--clear-only", action="store_true", help="Only clear the database"
    )
