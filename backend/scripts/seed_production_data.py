...
class ProductionSeeder:
    ...
    async def _create_restaurant_management(self):
        ...
        owner_password = bcrypt.hashpw(
            owner_password_str.encode("utf-8"), bcrypt.gensalt()
        )
        owner = User(
            id=str(uuid.uuid4()),
        ...
        manager_password = bcrypt.hashpw(
            manager_password_str.encode("utf-8"), bcrypt.gensalt()
        )
        manager = User(
            id=str(uuid.uuid4()),
    ...
    async def _create_employees(self):
        ...
        staff_data = [
            {
                ...
                "last_name": "Morales",
                "role": "employee",
                "email": "luis@casaestrella.co.uk",
                "phone": "+44 7723 445 667",
                "employee_role": "head_chef",
            ...
            },
            {
                ...
                "last_name": "Ramírez",
                "role": "employee",
                "email": "sofia@casaestrella.co.uk",
                "phone": "+44 7892 334 556",
                "employee_role": "sous_chef",
                "hourly_rate": Decimal("14.25"),
            ...
            },
            {
                ...
                "last_name": "Castillo",
                "role": "employee",
                "email": "diego@casaestrella.co.uk",
                "phone": "+44 7756 223 445",
                "employee_role": "line_cook",
                "hourly_rate": Decimal("12.80"),
            ...
            },
            {
                ...
                "last_name": "Torres",
                "role": "employee",
                "email": "isabella@casaestrella.co.uk",
                "phone": "+44 7667 112 334",
                "employee_role": "server",
                "hourly_rate": Decimal("11.50"),
            ...
            },
            {
                ...
                "last_name": "Vargas",
                "role": "employee",
                "email": "miguel@casaestrella.co.uk",
                "phone": "+44 7534 998 776",
                "employee_role": "server",
                "hourly_rate": Decimal("11.50"),
            ...
            },
            {
                ...
                "last_name": "Jiménez",
                "role": "employee",
                "email": "carmen@casaestrella.co.uk",
                "phone": "+44 7445 887 665",
                "employee_role": "server",
            ...
            },
            {
                ...
                "last_name": "Mendoza",
                "role": "employee",
                "email": "jose@casaestrella.co.uk",
                "phone": "+44 7778 554 332",
                "employee_role": "bartender",
                "hourly_rate": Decimal("12.20"),
            ...
            },
            {
                ...
                "last_name": "López",
                "role": "employee",
                "email": "ana@casaestrella.co.uk",
                "phone": "+44 7665 443 221",
                "employee_role": "cashier",
                "hourly_rate": Decimal("11.20"),
        ...
        for staff in staff_data:
            ...
            employee = EmployeeProfile(
                ...
                min_hours_per_week=(
                    10 if staff["employment_type"] == "part_time" else 30
                ),
                availability={
            ...
            logger.info(
                f"   ✓ {staff['first_name']} {staff['last_name']} - {staff['employee_role']}"
            )
    ...
    async def _create_menu_items(self):
        ...
        # Get category IDs
        antojitos_id = next(
            c["id"] for c in self.categories if c["name"] == "Antojitos"
        )
        tacos_id = next(c["id"] for c in self.categories if c["name"] == "Tacos")
        enchiladas_id = next(
            c["id"] for c in self.categories if c["name"] == "Enchiladas"
        )
        quesadillas_id = next(
            c["id"] for c in self.categories if c["name"] == "Quesadillas"
        )
        platos_id = next(
            c["id"] for c in self.categories if c["name"] == "Platos Principales"
        )
        ...
        menu_items = [
            ...
            },
            {
                ...
                "name_es": "Chiles Rellenos Pequeños",
                "description": "Fresh jalapeños stuffed with cream cheese, battered and fried",
                "category_id": antojitos_id,
                "price": Decimal("7.50"),
                "cost": Decimal("2.00"),
                "prep_time": 8,
            ...
            # Tacos
            {
                ...
                "name_es": "Taco de Carnitas",
                "description": "Slow-cooked pork shoulder with onions and cilantro on corn tortilla",
                "category_id": tacos_id,
                "price": Decimal("4.25"),
                "cost": Decimal("1.50"),
                "prep_time": 5,
                "allergens": [],
            ...
            {
                "name": "Taco de Pollo",
                "name_es": "Taco de Pollo",
                "description": "Grilled chicken with pico de gallo and avocado on corn tortilla",
                "category_id": tacos_id,
                "price": Decimal("4.50"),
                "cost": Decimal("1.75"),
                "prep_time": 6,
            ...
            },
            {
                ...
                "name_es": "Taco de Carne Asada",
                "description": "Grilled beef with onions, cilantro, and salsa verde on corn tortilla",
                "category_id": tacos_id,
                "price": Decimal("4.75"),
                "cost": Decimal("2.00"),
                "prep_time": 8,
            ...
            {
                "name": "Taco de Vegetales",
                "name_es": "Taco de Vegetales",
                "description": "Grilled peppers, onions, and mushrooms with black beans",
                "category_id": tacos_id,
                "price": Decimal("3.95"),
                "cost": Decimal("1.25"),
                "prep_time": 5,
            ...
            # Enchiladas
            {
                ...
                "description": "Three chicken enchiladas with green tomatillo sauce and Mexican cream",
                "category_id": enchiladas_id,
                "price": Decimal("14.95"),
                "cost": Decimal("4.50"),
                "prep_time": 15,
                "allergens": ["dairy", "gluten"],
            ...
            },
            {
                ...
                "description": "Three beef enchiladas with red chile sauce and melted cheese",
                "category_id": enchiladas_id,
                "price": Decimal("15.95"),
                "cost": Decimal("5.00"),
                "prep_time": 15,
            ...
            },
            {
                ...
                "name_es": "Enchiladas de Mole",
                "description": "Three chicken enchiladas with traditional mole sauce",
                "category_id": enchiladas_id,
                "price": Decimal("16.95"),
                "cost": Decimal("5.50"),
                "prep_time": 18,
            ...
            # Quesadillas
            {
                ...
                "name_es": "Quesadilla de Queso",
                "description": "Classic cheese quesadilla with Oaxaca and Monterey Jack cheese",
                "category_id": quesadillas_id,
                "price": Decimal("9.95"),
                "cost": Decimal("2.50"),
                "prep_time": 8,
                "allergens": ["dairy", "gluten"],
            ...
            },
            {
                ...
                "name_es": "Quesadilla de Pollo",
                "description": "Grilled chicken quesadilla with peppers, onions, and cheese",
                "category_id": quesadillas_id,
                "price": Decimal("12.95"),
                "cost": Decimal("3.75"),
                "prep_time": 10,
            ...
            },
            {
                ...
                "name_es": "Quesadilla de Hongos",
                "description": "Mushroom quesadilla with huitlacoche and Oaxaca cheese",
                "category_id": quesadillas_id,
                "price": Decimal("11.50"),
                "cost": Decimal("3.25"),
                "prep_time": 9,
            ...
            # Platos Principales
            {
                ...
                "name_es": "Plato de Carne Asada",
                "description": "Grilled beef steak with rice, beans, guacamole, and tortillas",
                "category_id": platos_id,
                "price": Decimal("18.95"),
                "cost": Decimal("6.50"),
                "prep_time": 20,
                "allergens": ["gluten"],
            ...
            },
            {
                ...
                "name_es": "Pollo a la Plancha",
                "description": "Grilled chicken breast with cilantro lime rice and black beans",
                "category_id": platos_id,
                "price": Decimal("16.95"),
                "cost": Decimal("5.25"),
                "prep_time": 18,
            ...
            },
            {
                ...
                "description": "Traditional chicken with complex mole sauce, rice, and tortillas",
                "category_id": platos_id,
                "price": Decimal("17.95"),
                "cost": Decimal("6.00"),
                "prep_time": 15,
            ...
            },
            {
                ...
                "name_es": "Pescado Veracruzano",
                "description": "Fish fillet in Veracruz-style sauce with olives, capers, and tomatoes",
                "category_id": platos_id,
                "price": Decimal("19.95"),
                "cost": Decimal("7.25"),
                "prep_time": 22,
            ...
            },
            {
                ...
                "name_es": "Bowl Vegetariano",
                "description": "Black beans, cilantro rice, grilled vegetables, guacamole, and salsa",
                "category_id": platos_id,
                "price": Decimal("13.95"),
                "cost": Decimal("3.50"),
                "prep_time": 12,
            ...
            # Bebidas
            {
                ...
                "name_es": "Margarita de Lima",
                "description": "Classic margarita with fresh lime juice and premium tequila",
            ...
            },
            {
                "name": "Horchata",
                "name_es": "Horchata",
                "description": "Traditional rice and cinnamon drink, served cold",
                "category_id": bebidas_id,
                "price": Decimal("4.50"),
                "cost": Decimal("1.00"),
                "prep_time": 2,
            ...
            {
                "name": "Agua Fresca (Watermelon)",
                "name_es": "Agua de Sandía",
                "description": "Fresh watermelon water with lime and mint",
                "category_id": bebidas_id,
                "price": Decimal("3.95"),
                "cost": Decimal("0.75"),
                "prep_time": 2,
            ...
            },
            {
                ...
                "description": "Rich hot chocolate with cinnamon and a touch of chili",
                "category_id": bebidas_id,
                "price": Decimal("4.25"),
                "cost": Decimal("1.25"),
                "prep_time": 5,
            ...
            {
                "name": "Cerveza (Corona)",
                "name_es": "Cerveza Corona",
                "description": "Mexican beer served with lime",
                "category_id": bebidas_id,
                "price": Decimal("4.95"),
                "cost": Decimal("1.50"),
                "prep_time": 1,
            ...
            # Postres
            {
                ...
                "description": "Sponge cake soaked in three types of milk with cinnamon",
                "category_id": postres_id,
                "price": Decimal("6.95"),
                "cost": Decimal("1.75"),
                "prep_time": 3,
                "allergens": ["dairy", "gluten", "eggs"],
            ...
            },
            {
                "name": "Flan",
                "name_es": "Flan",
                "description": "Traditional vanilla custard with caramel sauce",
                "category_id": postres_id,
                "price": Decimal("5.50"),
                "cost": Decimal("1.25"),
                "prep_time": 2,
            ...
            },
            {
                "name": "Sopapillas",
                "name_es": "Sopapillas",
                "description": "Fried pastry squares dusted with cinnamon sugar and honey",
                "category_id": postres_id,
                "price": Decimal("4.95"),
                "cost": Decimal("1.00"),
                "prep_time": 6,
    ...
    async def _create_inventory_items(self):
        ...
        for inv_data in inventory_data:
            inventory = InventoryItem(
                ...
                qty_g=(
                    int(inv_data["stock"])
                    if inv_data["unit"] in ["g", "ml"]
                    else int(inv_data["stock"] * 1000)
                ),
                par_level_g=(
                    int(inv_data["min"])
                    if inv_data["unit"] in ["g", "ml"]
                    else int(inv_data["min"] * 1000)
                ),
                unit=inv_data["unit"],
    ...
    async def _create_order_history(self):
        ...
        server_employees = [
            emp for emp in self.employees if emp["role"] in ["server", "cashier"]
        ]
            ...
            for order_num in range(daily_orders):
                ...
                order = Order(
                    ...
                    order_type=random.choices(
                        ["dine_in", "takeaway"], weights=[0.7, 0.3]
                    )[0],
                    table_number=(
                        str(random.randint(1, 20)) if random.random() > 0.3 else None
                    ),
                    status="completed",
                    items=[],
                ...
                payment_method = random.choices(
                    ["card", "cash", "qr_code"], weights=[0.6, 0.25, 0.15]
                )[0]
                ...
                payment = Payment(
                    ...
                    fee_amount=(
                        ...
                        else total_amount * Decimal("0.029")
                    ),
                    net_amount=(
                        total_amount
                        if payment_method == "cash"
                        else total_amount * Decimal("0.971")
                    ),
                    status="completed",
    ...
    async def _create_schedules(self):
        ...
        for week_offset in [0, 1]:
            ...
            for day_offset in range(7):  # Monday to Sunday
                ...
                if day_name in ["friday", "saturday"]:
                    # Weekend - more staff
                    scheduled_employees = random.sample(
                        self.employees, min(6, len(self.employees))
                    )
                elif day_name in ["tuesday", "wednesday", "thursday"]:
                    # Mid-week - moderate staff
                    scheduled_employees = random.sample(
                        self.employees, min(5, len(self.employees))
                    )
                else:
                    # Monday/Sunday - fewer staff
                    scheduled_employees = random.sample(
                        self.employees, min(4, len(self.employees))
                    )
        ...
        logger.info(
            f"   ✓ Created {schedules_created} shifts (current week + next week)"
        )
    ...
    async def _create_restaurant_settings(self):
        ...
        sections_data = [
            ...
            {
                "name": "Bar Area",
                "description": "Bar seating and cocktail area",
                "capacity": 12,
            },
