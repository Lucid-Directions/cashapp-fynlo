...
def get_inventory_item_by_sku(
    # Execute get_inventory_item_by_sku operation
...
def adjust_inventory_item_quantity(
    # Execute adjust_inventory_item_quantity operation
    db: Session,
    sku: str,
    change_qty_g: int,
    source: str,
...
def get_recipe_by_item_id(
    # Execute get_recipe_by_item_id operation
...
def create_recipe_for_item(
    # Execute create_recipe_for_item operation
    db: Session,
    item_id: UUID,
...
def create_or_update_recipe_ingredients(
    # Execute create_or_update_recipe_ingredients operation
    db: Session,
    item_id: UUID,
...
def delete_specific_ingredient_from_recipe(
    # Execute delete_specific_ingredient_from_recipe operation
...
def get_inventory_status_summary(
    # Execute get_inventory_status_summary operation
...
def get_low_stock_items(
    # Execute get_low_stock_items operation
...
def get_product_details_with_recipe(
    # Execute get_product_details_with_recipe operation
    db: Session, item_id: UUID, restaurant_id: UUID
) -> Optional[dict]:
    """
...
def get_all_products_with_recipes(
    # Execute get_all_products_with_recipes operation
