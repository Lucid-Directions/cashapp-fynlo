...
def get_inventory_item(
    db: Session, sku: str, restaurant_id: UUID
...
def create_inventory_item(
    db: Session, item: schemas.InventoryItemCreate, restaurant_id: UUID
) -> InventoryItem:
...
def update_inventory_item(
    db: Session, sku: str, item_update: schemas.InventoryItemUpdate, restaurant_id: UUID
) -> Optional[InventoryItem]:
...
def create_inventory_ledger_entry(
    db: Session, entry: schemas.InventoryLedgerEntryCreate, restaurant_id: UUID
...
def get_ledger_entries_for_sku(
    db: Session,
    sku: str,
    restaurant_id: UUID,
    skip: int = 0,
