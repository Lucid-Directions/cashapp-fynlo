...
class PlatformSettingsMigration:
    ...
    def migrate_payment_methods(
        # Execute migrate_payment_methods operation
    ...
    def migrate_payment_fees(
        # Execute migrate_payment_fees operation
    ...
    def migrate_provider_config(
        # Execute migrate_provider_config operation
        ...
        fee_configs = (
            ...
            .filter(
                and_(
                    ...
                    PlatformConfiguration.is_active,
                )
            )
            .all()
        )
    ...
    def create_migration_audit_record(
        # Execute create_migration_audit_record operation
