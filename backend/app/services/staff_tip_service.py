...
#         )
#
#         logger.info(f"Tip distributions for order {order_ref}:")
#         for dist in distributions:
#             logger.info(f"  Staff: {dist['staff_member']['name']}, Tip: {dist['tip_amount_allocated']}, Notes: {dist['notes']}")
#
...
#             logger.info(f"  Staff ID: {r_dist.staff_id}, Net Tip: {r_dist.tip_amount_net}, Gross Tip: {r_dist.tip_amount_gross}, Fee Impact: {r_dist.transaction_fee_impact_on_tip}")
#
#     finally:
#         db_session.close()
...
#             for r_dist in retrieved_dists:
#                 logger.info(f"  DB Record ID: {r_dist.id}, Staff ID: {r_dist.staff_id}, Net Tip: {r_dist.tip_amount_net}, Gross Tip: {r_dist.tip_amount_gross}, Fee Impact: {r_dist.transaction_fee_impact_on_tip}")
#         finally:
#             db_session.close()
