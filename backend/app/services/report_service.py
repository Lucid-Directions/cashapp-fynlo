...
class ReportAggregationService:
    ...
    def generate_daily_report(
        # Execute generate_daily_report operation
    ...
    def generate_hourly_metrics(
        # Execute generate_hourly_metrics operation
        self, restaurant_id: str, report_date: date
    ) -> List[HourlyMetric]:
        """
    ...
    def generate_reports_for_date_range(
        # Execute generate_reports_for_date_range operation
    ...
    def get_financial_summary(
        # Execute get_financial_summary operation
        self, restaurant_id: str, start_date: date, end_date: date
    ) -> Dict:
        """
