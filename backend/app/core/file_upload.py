...
try:
    ...
    logger.warning(
        "Warning: libmagic not available. Using fallback MIME type detection."
    )
...
class FileUploadService:
    ...
    def process_image(
        # Execute process_image operation
    ...
    def generate_variants(
        # Execute generate_variants operation
