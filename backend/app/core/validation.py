...
class BusinessValidator:
    ...
    def validate_order_creation(
        # Execute validate_order_creation operation
    ...
    def validate_order_status_transition(
        # Execute validate_order_status_transition operation
    ...
    def validate_payment_amount(
        # Execute validate_payment_amount operation
    ...
    def validate_business_hours(
        # Execute validate_business_hours operation
...
def raise_validation_exception(
    # Execute raise_validation_exception operation
...
def validate_payment_or_raise(
    # Execute validate_payment_or_raise operation
    order_total: float, payment_amount: float, payment_method: str
):
