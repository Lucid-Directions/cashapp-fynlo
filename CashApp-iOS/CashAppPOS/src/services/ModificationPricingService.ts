...
export const DEFAULT_MODIFICATIONS = {
  size: {
    ...
    options: [
      { id: 'size-small', name: 'Small', price: -0.50, default: false },
      { id: 'size-medium', name: 'Medium', price: 0.00, default: true },
      { id: 'size-large', name: 'Large', price: 0.50, default: false },
      { id: 'size-extra-large', name: 'Extra Large', price: 1.00, default: false }
    ]
  },
  temperature: {
    category: 'Temperature',
    options: [
      { id: 'temp-hot', name: 'Hot', price: 0.00, default: true },
      { id: 'temp-iced', name: 'Iced', price: 0.00, default: false },
      { id: 'temp-extra-hot', name: 'Extra Hot', price: 0.00, default: false }
    ]
  },
  coffeeAdditions: {
    ...
    options: [
      ...
      { id: 'add-decaf', name: 'Decaf', price: 0.00, quantity: false },
      { id: 'add-half-caff', name: 'Half Caff', price: 0.00, quantity: false },
      { id: 'add-whipped-cream', name: 'Whipped Cream', price: 0.25, quantity: false },
      { id: 'add-flavor-syrup', name: 'Flavor Syrup', price: 0.50, quantity: true, max: 3 },
      { id: 'add-extra-foam', name: 'Extra Foam', price: 0.00, quantity: false }
    ]
  },
  milkOptions: {
    category: 'Milk Options',
    options: [
      { id: 'milk-whole', name: 'Whole Milk', price: 0.00, default: true },
      { id: 'milk-skim', name: 'Skim Milk', price: 0.00, default: false },
      { id: 'milk-soy', name: 'Soy Milk', price: 0.60, default: false },
      { id: 'milk-almond', name: 'Almond Milk', price: 0.60, default: false },
      { id: 'milk-oat', name: 'Oat Milk', price: 0.70, default: false },
      { id: 'milk-coconut', name: 'Coconut Milk', price: 0.60, default: false }
    ]
  },
  removals: {
    category: 'Remove',
    options: [
      { id: 'remove-ice', name: 'No Ice', price: 0.00 },
      { id: 'remove-sugar', name: 'No Sugar', price: 0.00 },
      { id: 'remove-whip', name: 'No Whip', price: 0.00 }
    ]
  }
};
...
export class ModificationPricingService {
  ...
  validateModifications(modifications: CartItemModification[]): {
    ...
    const sizeSelections = modifications.filter(
