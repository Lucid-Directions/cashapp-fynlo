...
from cashapp import exceptions, tools
...
from cashapp.addons.sms.models.sms_sms import SmsApi, SmsSms
...
class SMSCase(MockSMS):
    ...
    def assertSMSNotification(self, recipients_info, content, messages=None, check_sms=True, sent_unlink=False,
        ...
        if messages is not None:
            ...
            with patch('cashapp.tools.mail.SANITIZE_TAGS', sanitize_tags):
