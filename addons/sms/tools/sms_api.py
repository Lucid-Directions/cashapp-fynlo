...
from cashapp import exceptions
...
ERROR_MESSAGES = {
    ...
    # Default error
    'unknown_error': _lt("An unknown error occurred. Please contact CashApp support if this error persists."),
}


class SmsApi:
    DEFAULT_ENDPOINT = 'https://sms.api.cashapp.com'
