...
from cashapp.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/cashapp", 0),
                ("http://localhost:8069/", "http://localhost:8069/cashapp/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/cashapp-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/web", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/cashapp", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/cashapp/", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/cashapp?debug=assets", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/cashapp#anchor", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/cashapp-experience", 1),
                ("https://www.cashapp.com/", "https://www.cashapp.com/cashapp/1519/tasks/4102866", 0),
                ("http://www.cashapp.com/", "https://www.cashapp.com/cashapp/1519/tasks/4102866", 1),
                ("https://www.cashapp.com/", "https://wwwacashapp.com/cashapp/", 1),
                ("https://www.cashapp.com/", "https://www.cashapp.com/chat/", 0),
                ("https://www.cashapp.com/", "https://www.cashapp.com/chat/5/bFtIfYHRco", 0),
                ("http://www.cashapp.com/", "https://www.cashapp.com/chat/5/bFtIfYHRco", 1),
                ("https://clients.cashapp.com/", "https://www.cashapp.com/cashapp/1519/tasks/4102866", 1),
                ("https://clients.cashapp.com/", "https://www.cashapp.com/chat/5/bFtIfYHRco", 1),
            ]
