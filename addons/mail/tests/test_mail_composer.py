...
class TestMailComposerForm(TestMailComposer):
    ...
    @mute_logger('cashapp.addons.mail.models.mail_mail')
    @users('employee')
    ...
    @mute_logger('cashapp.addons.base.models.ir_rule', 'cashapp.addons.mail.models.mail_mail')
    @users('employee')
...
class TestMailComposerUI(MailCommon, HttpCase):
    ...
    def test_mail_composer_test_tour(self):
        ...
        with self.mock_mail_app():
            self.start_tour(
                f"/cashapp/res.partner/{partner.id}",
