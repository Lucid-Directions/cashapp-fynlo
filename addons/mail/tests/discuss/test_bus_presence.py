...
from cashapp.tests import tagged, new_test_user
from cashapp.addons.bus.tests.common import WebsocketCase
from cashapp.addons.mail.tests.common import MailCommon
from cashapp.addons.bus.models.bus import channel_with_db, json_dump
...
class TestBusPresence(WebsocketCase, MailCommon):
    def _receive_presence(self, sender, recipient):
        ...
        self.subscribe(
            websocket,
            [f"cashapp-presence-{sender_bus_target._name}_{sender_bus_target.id}"],
