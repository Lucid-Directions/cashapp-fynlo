...
from cashapp.addons.base.tests.common import HttpCase, HttpCaseWithUserDemo
from cashapp.addons.mail.tests.common import MailCommon, mail_new_test_user
from cashapp.http import STATIC_CACHE_LONG
from cashapp import Command, fields, http
...
class TestMessageController(HttpCaseWithUserDemo):
    ...
    @mute_logger("cashapp.addons.http_routing.models.ir_http", "cashapp.http")
...
class TestMessageLinks(MailCommon, HttpCase):
    ...
    def test_message_link_by_employee(self):
        ...
        with self.subTest(channel_message=channel_message):
            expected_url = self.base_url() + f'/cashapp/action-mail.action_discuss?active_id={channel_message.res_id}&highlight_message_id={channel_message.id}'
