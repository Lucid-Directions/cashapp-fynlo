...
from cashapp.addons.mail.models.mail_activity import MailActivity
from cashapp.addons.mail.tests.common import MailCommon
from cashapp.tests import Form, tagged, HttpCase
...
class TestMailActivityChatter(HttpCase):
    ...
    def test_mail_activity_schedule_from_chatter(self):
        ...
        self.start_tour(
            f"/cashapp/res.partner/{testuser.partner_id.id}",
