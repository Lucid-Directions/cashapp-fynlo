...
from cashapp import _, api, Command, fields, models, modules, tools
from cashapp.tools import email_normalize
        ...
        store.add(
            {
                ...
                # sudo: res.partner - exposing CashAppBot data is considered acceptable
                "cashappbot": Store.one(self.env.ref("base.partner_root").sudo()),
            }
        )
