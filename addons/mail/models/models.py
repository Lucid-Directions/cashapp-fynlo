...
from cashapp import api, exceptions, models, tools, _
from cashapp.addons.mail.tools.alias_error import AliasError
...
class BaseModel(models.AbstractModel):
    ...
    def _notify_by_email_get_headers(self, headers=None):
        ...
        if not self:
            return headers
        self.ensure_one()
        headers['X-CashApp-Objects'] = f"{self._name}-{self.id}"
