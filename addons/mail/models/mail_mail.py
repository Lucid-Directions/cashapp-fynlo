...
from cashapp import _, api, fields, models, modules, SUPERUSER_ID, tools
from cashapp.addons.base.models.ir_mail_server import MailDeliveryException
        ...
        for mail_server_id, alias_domain_id, smtp_from, batch_ids in self._split_by_mail_configuration():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an CashApp MailDeliveryException
