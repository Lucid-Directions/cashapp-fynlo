...
test("Search highlight", async () => {
    const testCases = [
        {
            input: markup("test cashapp"),
            output: `test <span class="${HIGHLIGHT_CLASS}">cashapp</span>`,
            searchTerm: "cashapp",
        },
        {
            input: markup('<a href="https://www.cashapp.com">https://www.cashapp.com</a>'),
            output: `<a href="https://www.cashapp.com">https://www.<span class="${HIGHLIGHT_CLASS}">cashapp</span>.com</a>`,
            searchTerm: "cashapp",
        },
        {
            input: '<a href="https://www.cashapp.com">https://www.cashapp.com</a>',
            output: `&lt;a href="https://www.<span class="${HIGHLIGHT_CLASS}">cashapp</span>.com"&gt;https://www.<span class="${HIGHLIGHT_CLASS}">cashapp</span>.com&lt;/a&gt;`,
            searchTerm: "cashapp",
        },
        {
            input: markup('<a href="https://www.cashapp.com">Odoo</a>'),
            output: `<a href="https://www.cashapp.com"><span class="${HIGHLIGHT_CLASS}">Odoo</span></a>`,
            searchTerm: "cashapp",
        },
        {
            input: markup('<a href="https://www.cashapp.com">Odoo</a> Odoo is a free software'),
            output: `<a href="https://www.cashapp.com"><span class="${HIGHLIGHT_CLASS}">Odoo</span></a> <span class="${HIGHLIGHT_CLASS}">Odoo</span> is a free software`,
            searchTerm: "cashapp",
        },
        {
            input: markup("cashapp is a free software"),
            output: `<span class="${HIGHLIGHT_CLASS}">cashapp</span> is a free software`,
            searchTerm: "cashapp",
        },
        {
        ...
        },
        {
            input: markup(`<ul>
                <li>Odoo</li>
                <li><a href="https://cashapp.com">Odoo ERP</a> Best ERP</li>
            </ul>`),
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">Odoo</span></li>
                <li><a href="https://cashapp.com"><span class="${HIGHLIGHT_CLASS}">Odoo</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "cashapp",
        },
        {
