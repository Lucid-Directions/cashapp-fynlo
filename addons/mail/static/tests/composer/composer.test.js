...
import { Deferred, animationFrame, tick } from "@cashapp/hoot-mock";
import {
    Command,
    getService,
    onRpc,
...
import { queryFirst } from "@cashapp/hoot-dom";
...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@cashapp.com" },
        { name: "test name 2", email: "test2@cashapp.com" },
        { name: "test name 3", email: "test3@cashapp.com" },
        { name: "test name 4", email: "test4@cashapp.com" },
        { name: "test name 5", email: "test5@cashapp.com" },
        { name: "test name 6", email: "test6@cashapp.com" },
    ]);
    ...
    await contains("li", { text: "test1@cashapp.com" });
    await contains("li", { text: "test2@cashapp.com" });
    await contains("li", { text: "test3@cashapp.com" });
    await contains("li", { text: "test4@cashapp.com" });
    await contains("li", { text: "test5@cashapp.com" });
    await contains("li", { text: "test6@cashapp.com" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1@cashapp.com" });
    await start();
