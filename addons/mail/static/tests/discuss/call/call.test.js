...
import { advanceTime, hover, manuallyDispatchProgrammaticEvent, queryFirst } from "@cashapp/hoot-dom";
import { mockSendBeacon, mockUserAgent } from "@cashapp/hoot-mock";
import {
    Command,
    mockService,
    patchWithCleanup,
...
test("no call with cashappbot", async () => {
    const pyEnv = await startServer();
