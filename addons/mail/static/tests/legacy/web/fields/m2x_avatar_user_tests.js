/** @cashapp-module alias=@mail/../tests/web/fields/m2x_avatar_user_tests default=false */
...
test("avatar card preview", async (assert) => {
    ...
    await contains(".o_card_user_infos > a", { text: "Mario@cashapp.test" });
