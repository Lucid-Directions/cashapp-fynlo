...
Communicate with your colleagues/customers/guest within CashApp.
...
from CashApp itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your CashApp system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled CashApp documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-CashApp integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within CashApp, and the
answers will automatically be collected when they come back, and attached to the
same *conversation* document.
For more specific needs, you may also assign custom-defined actions
(technically: Server Actions) to be triggered for each incoming mail.
    """,
    'website': 'https://www.cashapp.com/app/discuss',
    ...
    'assets': {
        ...
        'mail.assets_cashapp_sfu': [
            'mail/static/lib/cashapp_sfu/cashapp_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/cashapp_ui_icons/style.css',
