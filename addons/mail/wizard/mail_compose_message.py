...
from cashapp import _, api, fields, models, Command, tools
from cashapp.exceptions import UserError, ValidationError
from cashapp.osv import expression
from cashapp.tools.mail import is_html_empty, email_normalize, email_split_and_format
from cashapp.addons.mail.tools.parser import parse_res_ids
...
class MailComposer(models.TransientModel):
    ...
    auto_delete = fields.Boolean(
        ...
        help='This option permanently removes any track of email after it\'s been sent, including from the Technical menu in the Settings, in order to preserve storage space of your CashApp database.')
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an CashApp domain (list of leaves) """
        self.ensure_one()
