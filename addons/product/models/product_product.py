...
from cashapp.tools import float_compare, format_list, groupby
from cashapp.tools.image import is_image_size_above
from cashapp.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('cashapp.sql_db'):
                self.unlink()
        except Exception:
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/cashapp/cashapp/pull/38303
