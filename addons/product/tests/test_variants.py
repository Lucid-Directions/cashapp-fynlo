...
from cashapp.tests import tagged, TransactionCase, Form
from cashapp.tools import mute_logger

from cashapp.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariants(ProductVariantsCommon):
    ...
    def test_variants_pricelist_code(self):
        vendor = self.env['res.partner'].create({'name': 'Bidou', 'email': 'bidou@cashapp.com'})
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'cashapp.addons.product.models.product_product.ProductProduct._filter_to_unlink',
