...
from cashapp.modules import get_manifest
...
class WebClient(http.Controller):
    ...
    def translations(self, unique, mods=None, lang=None):
        ...
        if mods:
            ...
            mods = list(request.env.registry._init_modules) + (cashapp.conf.server_wide_modules or [])
    ...
    def version_info(self):
        return cashapp.service.common.exp_version()
