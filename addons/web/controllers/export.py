...
from cashapp.http import content_disposition, request
from cashapp.tools import lazy_property, osutil
from cashapp.tools.misc import xlsxwriter
...
class ExportFormat(object):
    ...
    def from_data(self, fields, columns_headers, rows):
        """ Conversion method from CashApp's export data to whatever the
