...
from cashapp.http import content_disposition, dispatch_rpc, request, Response
from cashapp.service import db
from cashapp.tools.misc import file_open, str2bool
from cashapp.tools.translate import _

from cashapp.addons.base.models.ir_qweb import render as qweb_render
...
class Database(http.Controller):
    ...
    def _render_template(self, **d):
        ...
        d['insecure'] = cashapp.tools.config.verify_admin_password('admin')
        d['list_db'] = cashapp.tools.config['list_db']
        d['langs'] = cashapp.service.db.exp_list_lang()
        d['countries'] = cashapp.service.db.exp_list_countries()
        d['pattern'] = DBNAME_PATTERN
        # databases list
        try:
            d['databases'] = http.db_list()
            d['incompatible_databases'] = cashapp.service.db.list_db_incompatible(d['databases'])
        except cashapp.exceptions.AccessDenied:
    ...
    def create(self, master_pwd, name, lang, password, **post):
        insecure = cashapp.tools.config.verify_admin_password('admin')
        ...
        try:
            ...
            return request.redirect('/cashapp')
    ...
    def backup(self, master_pwd, name, backup_format='zip'):
        ...
        if insecure and master_pwd:
            dispatch_rpc('db', 'change_admin_password', ["admin", master_pwd])
        try:
            cashapp.service.db.check_super(master_pwd)
            ...
            dump_stream = cashapp.service.db.dump_db(name, None, backup_format)
