...
import cashapp
from cashapp import api, models, fields
from cashapp.http import request, DEFAULT_MAX_CONTENT_LENGTH
from cashapp.tools import ormcache, config
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = cashapp.service.common.exp_version()
        ...
        mods = cashapp.conf.server_wide_modules or []
        if request.db:
        ...
        session_info = {
            ...
            "support_url": "https://www.cashapp.com/buy",
            "name": user.name,
            "username": user.login,
