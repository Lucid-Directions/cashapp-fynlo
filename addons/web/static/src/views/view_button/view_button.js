...
const cashappToBootstrapClasses = {
...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(cashapp.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in cashappToBootstrapClasses) {
                    cls = cashappToBootstrapClasses[cls];
                }
                classNames.push(cls);
