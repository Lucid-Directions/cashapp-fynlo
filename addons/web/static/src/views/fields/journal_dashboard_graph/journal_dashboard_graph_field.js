...
import { Component, onWillStart, useEffect, useRef } from "@cashapp/owl";
...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "cashapp");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "cashapp");
        const color19 = getColor(1, cookie.get("color_scheme"), "cashapp");
