...
import { cashappExceptionTitleMap } from "@web/core/errors/error_dialogs";
import { _t } from "@web/core/l10n/translation";

cashappExceptionTitleMap.forEach((title, exceptionName) => {
...
registry
    ...
    .add("cashapp.http.SessionExpiredException", sessionExpired)
