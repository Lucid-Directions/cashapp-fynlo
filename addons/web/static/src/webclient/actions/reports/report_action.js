...
import { Component, useRef, useSubEnv } from "@cashapp/owl";
 ...
 * It uses a feature to automatically create links to other cashapp pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
