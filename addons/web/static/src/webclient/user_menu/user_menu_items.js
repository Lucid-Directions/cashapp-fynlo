import { Component, markup } from "@cashapp/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.cashapp.com/documentation/18.0";
    return {
        type: "item",
        id: "documentation",
...
export function cashappAccountItem(env) {
    return {
        type: "item",
        id: "account",
        ...
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.cashapp.com/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("cashapp_account", cashappAccountItem)
