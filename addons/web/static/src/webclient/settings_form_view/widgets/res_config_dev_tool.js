...
import { Component, onWillStart } from "@cashapp/owl";
...
export class ResConfigDevTool extends Component {
    ...
    setup() {
        this.isDebug = Boolean(cashapp.debug);
        this.isAssets = cashapp.debug.includes("assets");
        this.isTests = cashapp.debug.includes("tests");
