import { after, beforeEach, expect, test } from "@cashapp/hoot";
import {
    click,
    dblclick,
    drag,
...
import { Deferred, advanceFrame, animationFrame, runAllTimers, tick } from "@cashapp/hoot-mock";
import { Component, onRendered, onWillRender, xml } from "@cashapp/owl";
import {
    MockServer,
    clickKanbanLoadMore,
    clickModalButton,
...
test("quick create record: cancel when modal is opened", async () => {
    ...
    // Check cashapp/cashapp#61981 for more details.
