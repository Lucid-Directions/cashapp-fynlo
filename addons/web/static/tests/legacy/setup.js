/** @cashapp-module alias=@web/../tests/setup default=false */
...
import { App, EventBus, whenReady } from "@cashapp/owl";
...
function makeMockLocation() {
    return Object.assign(document.createElement("a"), {
        href: window.location.origin + "/cashapp",
        assign(url) {
            this.href = url;
        },
        reload() {},
