/** @cashapp-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@cashapp/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await cashapp.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (cashapp.debug && cashapp.debug.includes("assets")) {
