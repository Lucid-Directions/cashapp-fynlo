import { beforeEach, expect, getFixture, test } from "@cashapp/hoot";
import { microTick, tick } from "@cashapp/hoot-dom";
...
const ModuleLoader = Object.getPrototypeOf(cashapp.loader.constructor);
