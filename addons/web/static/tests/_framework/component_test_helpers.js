import { after, destroy, getFixture } from "@cashapp/hoot";
import { queryFirst, queryOne } from "@cashapp/hoot-dom";
import { App, Component, xml } from "@cashapp/owl";
 ...
 * @typedef {import("@cashapp/owl").Component} Component
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@cashapp/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
