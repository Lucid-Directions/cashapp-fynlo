...
import { after, before, beforeEach, createJobScopedGetter } from "@cashapp/hoot";
import { validateType } from "@cashapp/owl";

const { view_info } = cashapp.__session_info__ || {};
delete cashapp.__session_info__;
...
const SERVER_STATE_VALUES_SCHEMA = {
    ...
    lang: String,
    multiLang: Boolean,
    cashappbotId: [Number, { value: false }],
