import { after, expect, getFixture } from "@cashapp/hoot";
import { click, formatXml, queryAll, queryAllTexts } from "@cashapp/hoot-dom";
import { animationFrame, Deferred, tick } from "@cashapp/hoot-mock";
import { Component, onMounted, useSubEnv, xml } from "@cashapp/owl";
