import { after, afterEach } from "@cashapp/hoot";
import {
    check,
    clear,
    click,
...
import { advanceFrame, advanceTime, animationFrame } from "@cashapp/hoot-mock";
import { hasTouch } from "@web/core/browser/feature_detection";

/**
 * @typedef {import("@cashapp/hoot-dom").DragHelpers} DragHelpers
 * @typedef {import("@cashapp/hoot-dom").DragOptions} DragOptions
 * @typedef {import("@cashapp/hoot-dom").FillOptions} FillOptions
 * @typedef {import("@cashapp/hoot-dom").InputValue} InputValue
 * @typedef {import("@cashapp/hoot-dom").KeyStrokes} KeyStrokes
 * @typedef {import("@cashapp/hoot-dom").PointerOptions} PointerOptions
 * @typedef {import("@cashapp/hoot-dom").Position} Position
 * @typedef {import("@cashapp/hoot-dom").QueryOptions} QueryOptions
 * @typedef {import("@cashapp/hoot-dom").Target} Target
 *
 * @typedef {DragOptions & {
...
/**
 * @template T
 * @typedef {import("@cashapp/hoot-dom").MaybePromise<T>} MaybePromise
 */
