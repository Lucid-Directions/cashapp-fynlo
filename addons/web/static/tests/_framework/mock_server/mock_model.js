import { after, createJobScopedGetter } from "@cashapp/hoot";
 ...
 * @param {string} fieldName
 */
function getDateSortingValue(group, fieldName) {
 ...
 */
function getDateNumberSortingValue(group, fieldName) {
    let max = -1;
    let value = false;
