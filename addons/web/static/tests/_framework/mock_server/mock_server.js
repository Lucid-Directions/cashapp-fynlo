import { before, createJobScopedGetter, expect, getCurrent, registerDebugInfo } from "@cashapp/hoot";
import { mockFetch, mockWebSocket } from "@cashapp/hoot-mock";
 ...
 * }} ServerParams
 *
 * @typedef {import("@cashapp/hoot-mock").ServerWebSocket} ServerWebSocket
 *
    ...
    _findAction(id) {
        ...
        if (!actions.length) {
            throw makeServerError({
                errorName: "cashapp.addons.web.controllers.action.MissingActionError",
