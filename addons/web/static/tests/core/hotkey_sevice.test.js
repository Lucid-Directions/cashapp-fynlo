import { destroy, expect, getFixture, onError, test } from "@cashapp/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@cashapp/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@cashapp/hoot-mock";
import { Component, useRef, useState, xml } from "@cashapp/owl";
import {
    contains,
    getService,
    makeMockEnv,
