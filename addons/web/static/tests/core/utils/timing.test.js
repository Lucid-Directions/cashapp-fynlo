import { describe, destroy, expect, getFixture, test } from "@cashapp/hoot";
import { click, tick } from "@cashapp/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@cashapp/hoot-mock";
