...
import { describe, test, expect } from "@cashapp/hoot";
import { animationFrame, tick } from "@cashapp/hoot-mock";
import {
    mountWithCleanup,
    patchWithCleanup,
    mockService,
...
import { click, freezeTime, queryAllTexts } from "@cashapp/hoot-dom";
import {
    ClientErrorDialog,
    Error504Dialog,
    ErrorDialog,
...
test("WarningDialog", async () => {
    ...
    await mountWithCleanup(WarningDialog, {
        env,
        props: {
            exceptionName: "cashapp.exceptions.UserError",
            message: "...",
