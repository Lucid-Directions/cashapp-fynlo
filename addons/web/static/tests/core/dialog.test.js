import { destroy, expect, test } from "@cashapp/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@cashapp/hoot-dom";
import { animationFrame } from "@cashapp/hoot-mock";
import { Component, onMounted, useState, xml } from "@cashapp/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
