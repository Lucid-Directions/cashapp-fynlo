/** @cashapp-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@cashapp/hoot";
import { hover, queryFirst } from "@cashapp/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@cashapp/hoot-mock";
import { Component, onPatched, xml } from "@cashapp/owl";
import {
    contains,
    mountWithCleanup,
    patchWithCleanup,
