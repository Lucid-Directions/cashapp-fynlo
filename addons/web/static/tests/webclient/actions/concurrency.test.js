...
import { queryAll, queryAllTexts, runAllTimers } from "@cashapp/hoot-dom";
import { animationFrame, Deferred } from "@cashapp/hoot-mock";
import { Component, onWillStart, xml } from "@cashapp/owl";
import {
    contains,
    defineActions,
    defineModels,
...
test("execute a new action while loading a lazy-loaded controller", async () => {
    redirect("/cashapp/action-4/2?cids=1");
