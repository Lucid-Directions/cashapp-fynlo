...
import { click, queryAllAttributes, queryAllProperties, queryAllTexts } from "@cashapp/hoot-dom";
...
import { cashappAccountItem, preferencesItem } from "@web/webclient/user_menu/user_menu_items";
...
test("click on cashapp account item", async () => {
    patchWithCleanup(browser, {
        open: (url) => expect.step(`open ${url}`),
    });
    userMenuRegistry.add("cashapp_account", cashappAccountItem);
    await mountWithCleanup(UserMenu);
