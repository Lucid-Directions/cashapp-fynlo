...
import { Component, onPatched, onWillPatch, useRef, useState, xml } from "@cashapp/owl";
...
export class HootSearch extends Component {
    ...
    findSuggestions() {
        ...
        return {
            suite: this.filterItems(parsedQuery, suites, "suite"),
            tag: this.filterItems(parsedQuery, tags, "tag"),
            test: this.filterItems(parsedQuery, tests, "test"),
        };
    }
