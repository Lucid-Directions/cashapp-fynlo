...
/**
 * @typedef {Parameters<typeof import("@cashapp/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@cashapp/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@cashapp/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@cashapp/owl").Component} target
 */
