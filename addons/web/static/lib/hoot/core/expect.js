...
import { markRaw } from "@cashapp/owl";
import {
    formatXml,
    getActiveElement,
    getNodeAttribute,
 ...
 *
 * @typedef {import("@cashapp/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@cashapp/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@cashapp/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@cashapp/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/cashapp/i);
     */
