...
import { after, describe, expect, getFixture, test } from "@cashapp/hoot";
import {
    clear,
    click,
    dblclick,
...
import { advanceTime, animationFrame, mockFetch, mockTouch, mockUserAgent } from "@cashapp/hoot-mock";
