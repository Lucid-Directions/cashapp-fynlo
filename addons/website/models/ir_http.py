...
from cashapp.tools.json import scriptsafe as json_scriptsafe
from cashapp.tools.safe_eval import safe_eval
from cashapp.osv.expression import FALSE_DOMAIN
from cashapp.addons.base.models.ir_http import EXTENSION_TO_WEB_MIMETYPES
from cashapp.addons.http_routing.models import ir_http
from cashapp.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from cashapp.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(cashapp.conf.server_wide_modules)
