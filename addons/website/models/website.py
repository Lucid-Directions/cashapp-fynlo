...
from cashapp import api, fields, models, tools, release
from cashapp.addons.website.models.ir_http import sitemap_qs2dom
from cashapp.addons.website.tools import similarity_score, text_from_html, get_base_domain
from cashapp.addons.portal.controllers.portal import pager
from cashapp.addons.iap.tools import iap_tools
from cashapp.exceptions import AccessError, UserError, ValidationError
from cashapp.http import request
from cashapp.modules.module import get_manifest
from cashapp.osv.expression import AND, OR, FALSE_DOMAIN
from cashapp.tools import SQL, Query, sql as sqltools
from cashapp.tools.translate import _, xml_translate
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.cashapp.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.cashapp.com'
...
class Website(models.Model):
        ...
        for model_name, field_name in html_fields:
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/cashapp/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the CashApp framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False):
        ...
        return "/cashapp/action-website.website_preview?" + urls.url_encode(action_params)
