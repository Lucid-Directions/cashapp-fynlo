...
registry.slider = publicWidget.Widget.extend({
    ...
    start: function () {
        ...
        if (this.editableMode && this.el.matches("section > .carousel")
            ...
            this.options.wysiwyg.cashappEditor.observerUnactive("disable_controls");
            ...
            this.options.wysiwyg.cashappEditor.observerActive("disable_controls");
    ...
    destroy: function () {
        ...
        this.options.wysiwyg && this.options.wysiwyg.cashappEditor.observerUnactive("destroy");
        this.$(".carousel-item")
            .toArray()
            .forEach((el) => {
                $(el).css("min-height", "");
            });
        this.options.wysiwyg && this.options.wysiwyg.cashappEditor.observerActive("destroy");
        ...
        if (this.editableMode && this.el.matches("section > .carousel")
            ...
            const indicatorEls = this.el.querySelectorAll(".carousel-indicators > *");
            this.options.wysiwyg.cashappEditor.observerUnactive("restore_controls");
            ...
            this.options.wysiwyg.cashappEditor.observerActive("restore_controls");
            [...this.controlEls, ...indicatorEls].forEach(controlEl => {
    ...
    _computeHeights: function () {
        ...
        this.options.wysiwyg && this.options.wysiwyg.cashappEditor.observerUnactive("_computeHeights");
        ...
        this.options.wysiwyg && this.options.wysiwyg.cashappEditor.observerActive("_computeHeights");
    },
...
registry.Parallax = Animation.extend({
    ...
    _updateBgCss(cssValues) {
        ...
        if (this.options.wysiwyg) {
            this.options.wysiwyg.cashappEditor.observerUnactive('_updateBgCss');
        }
        this.$bg.css(cssValues);
        if (this.options.wysiwyg) {
            this.options.wysiwyg.cashappEditor.observerActive('_updateBgCss');
        }
    },
...
registry.ImagesLazyLoading = publicWidget.Widget.extend({
    ...
    _updateImgMinHeight(imgEl, reset = false) {
        if (this.options.wysiwyg) {
            this.options.wysiwyg.cashappEditor.observerUnactive('_updateImgMinHeight');
        }
        if (reset) {
        ...
        if (this.options.wysiwyg) {
            this.options.wysiwyg.cashappEditor.observerActive('_updateImgMinHeight');
        }
    },
});
...
￼    */
    _setImgSrc(svg, resolve) {
        ...
        preloadedImg.onload = () => {
            ...
            this.options.wysiwyg && this.options.wysiwyg.cashappEditor.observerUnactive("setImgHoverEffectSrc");
            ...
            this.options.wysiwyg && this.options.wysiwyg.cashappEditor.observerActive("setImgHoverEffectSrc");
