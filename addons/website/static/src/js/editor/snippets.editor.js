...
import * as OdooEditorLib from "@web_editor/js/editor/cashapp-editor/src/utils/utils";
import { Component, onMounted, onWillStart, useEffect, useRef, useState } from "@cashapp/owl";
...
export class WebsiteSnippetsMenu extends weSnippetEditor.SnippetsMenu {
     ...
     */
    _getSelection() {
        return this.options.wysiwyg.cashappEditor.document.getSelection();
    }
    /**
     * @override
     */
    _addToolbar() {
        ...
        this.options.wysiwyg.cashappEditor.computeFontSizeSelectorValues();
    }
    /**
    * @override
    */
    ...
    _handleTextOptions(classSelector, optionClassList, textOptionsPostActivate = () => {}) {
        ...
        if (selectedTextEl) {
            ...
            this.options.wysiwyg.cashappEditor.historyResetLatestComputedSelection();
            this.options.wysiwyg.cashappEditor.historyStep(true);
            restoreCursor();
