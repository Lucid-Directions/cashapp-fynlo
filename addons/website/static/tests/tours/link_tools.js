...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/cashapp-editor/src/utils/utils';
...
registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL cashapp.com",
        trigger: '#toolbar:not(.oe-floating) #o_link_dialog_url_input',
        run: 'edit cashapp.com',
    },
    clickOnImgStep,
    {
        content: "Select the newly created link",
        trigger: ':iframe #wrap .s_text_image a[href="http://cashapp.com"]:contains("cashapp.com")',
        run() {
    ...
    },
    {
        ...
        trigger: ':iframe .popover:contains("http://cashapp.com") a .fa-chain-broken',
        run: 'click',
    },
    {
        content: "Check that the link was removed",
        trigger: ':iframe #wrap .s_text_image p:contains("Go to cashapp:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: ':iframe .s_text_image a[href="http://cashapp.com"]:contains("cashapp.com")',
        run: "click",
    },
    {
        content: "Change content (editing the label input) to cashapp website_2",
        trigger: '#o_link_dialog_label_input:value(cashapp.com)',
        run: 'edit cashapp website_2',
    },
    {
        content: "Change content (editing the DOM) to cashapp website",
        trigger: ':iframe .s_text_image a[href="http://cashapp.com"]:contains("cashapp website_2")',
        run: 'editor cashapp website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: ':iframe .s_text_image a[href="http://cashapp.com"]:contains("cashapp website")',
        run: "click",
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:value(cashapp website)',
    },
    {
    ...
    ...clickOnEditAndWaitEditMode(),
    {
        content: "The new link content should be cashapp website and url cashapp.be",
        trigger: ':iframe .s_text_image a[href="http://cashapp.be"]:contains("cashapp website")',
        run: "click",
    },
    {
        content: "The new link content should be cashapp website and url cashapp.be",
    ...
    ...clickOnSave(),
    {
        ...
        trigger: ':iframe .s_text_image a.btn.btn-secondary[href="http://cashapp.be"]:contains("cashapp website")',
    },
    // 4. Add link on image.
    ...clickOnEditAndWaitEditMode(),
    ...insertSnippet({
    ...
    },
    {
        ...
        // TODO: remove && click
        run: "edit cashapp.com && click(we-title:contains(Your URL))",
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe .popover div a:contains("http://cashapp.com")',
    },
    ...clickOnSave(),
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.cashapp.com",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.cashapp.com']:has(img):has(h4):has(span)",
    },
    ...
    },
    {
        ...
        trigger: ':iframe #wrap .s_text_image p',
        run: "editor cashapp.com",
    },
    {
        content: "Select text",
        trigger: ':iframe #wrap .s_text_image p:contains(cashapp.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http://cashapp.com']:contains('cashapp.com')",
    },
    {
        content: "Click on link to open the link tools",
        trigger: ":iframe .s_text_image p a[href='http://cashapp.com']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https://cashapp.com")
            // To see what happens with edit, add `pause:true` to the previous step
            // and type yourself https://cashapp.com in #o_link_dialog_url_input
            // The label will be ohttps://
            this.anchor.value = "https://cashapp.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
        content: "Check that link was updated",
        trigger: ":iframe .s_text_image p a[href='https://cashapp.com']:contains('cashapp.com')",
    },
    {
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http://cashapp.com")
            this.anchor.value = "http://cashapp.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/cashapp/cashapp/commit/9fc283b514d420fdfd66123845d9ec3563572692
