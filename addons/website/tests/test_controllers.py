...
from cashapp import tests
from cashapp.tools.misc import mute_logger, submap
from cashapp.addons.website.controllers.main import Website
...
class TestControllers(tests.HttpCase):
    ...
    def test_02_client_action_iframe_url(self):
        ...
        for url in urls:
            ...
            self.assertURLEqual(
                resp.url, f'/cashapp/action-website.website_preview?{backend_params}',
