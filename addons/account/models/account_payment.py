# -*- coding: utf-8 -*-
from cashapp import models, fields, api, _, Command
from cashapp.exceptions import UserError, ValidationError
from cashapp.tools.misc import format_date, formatLang
from cashapp.tools import create_index
...
class AccountPayment(models.Model):
    ...
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Method',
        ...
        help="Manual: Pay or Get paid by any method outside of CashApp.\n"
