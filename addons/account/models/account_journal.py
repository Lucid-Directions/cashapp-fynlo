...
from cashapp import api, Command, fields, models, _
from cashapp.exceptions import UserError, ValidationError
from cashapp.addons.base.models.res_bank import sanitize_account_number
from cashapp.tools import groupby
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('cashapp', 'CashApp'), ('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the CashApp reference.")
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of CashApp.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of CashApp.\n"
        "Check: Pay bills by check and print it from CashApp.\n"
    ...
    alias_id = fields.Many2one(help="Send one separate email for each invoice.\n\n"
                                    ...
                                    "Only PDF and XML files will be interpreted by CashApp")
