...
from cashapp import models, api, _, fields, Command, tools
from cashapp.exceptions import UserError
from cashapp.osv import expression
from cashapp.release import version
from cashapp.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from cashapp.tools.misc import formatLang, format_date as cashapp_format_date, get_lang
      ...
      LEFT JOIN mail_activity_type act_type ON activity.activity_type_id = act_type.id
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': cashapp_format_date(self.env, activity['date_deadline'])
            }
