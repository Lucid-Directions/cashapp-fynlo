...
from cashapp.tests import standalone
from cashapp.addons.account.models.chart_template import AccountChartTemplate
...
def test_all_l10n(env):
    ...
    logger = logging.getLogger('cashapp.loading')
