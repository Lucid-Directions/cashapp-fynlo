...
from cashapp import api, fields, models, _, Command, tools, SUPERUSER_ID
from cashapp.http import request
from cashapp.exceptions import AccessError, ValidationError, UserError
from cashapp.tools import convert, SQL
...
class PosConfig(models.Model):
    ...
    sequence_id = fields.Many2one('ir.sequence', string='Order IDs Sequence', readonly=True,
        help="This sequence is automatically created by CashApp but you can change it "
