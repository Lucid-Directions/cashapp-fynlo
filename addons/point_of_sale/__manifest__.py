...

{
    ...
    'installable': True,
    'application': True,
    'website': 'https://www.cashapp.com/app/point-of-sale-shop',
    'assets': {
        ...
        'point_of_sale.base_app': [
            ...
            "web/static/lib/cashapp_ui_icons/*",
        ...
        'point_of_sale._assets_pos': [
            ...
            'web/static/lib/owl/cashapp_module.js',
        ...
        'point_of_sale.customer_display_assets': [
            ('include', 'point_of_sale.base_app'),
            "point_of_sale/static/src/app/generic_components/cashapp_logo/*",
