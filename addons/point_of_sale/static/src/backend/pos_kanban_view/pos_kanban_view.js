...
import { onWillStart, useState, onWillRender } from "@cashapp/owl";
...
export class PosKanbanRenderer extends KanbanRenderer {
    ...
    async callWithViewUpdate(func) {
        try {
            ...
            if (e.exceptionName === "cashapp.exceptions.AccessError") {
    ...
    createNewProducts() {
        window.open("/cashapp/action-point_of_sale.action_client_product_menu", "_self");
    }
