...
export class PosStore extends Reactive {
    ...
    async processServerData() {
        ...
        this.models["pos.session"].getFirst().login_number = parseInt(cashapp.login_number);
    ...
    redirectToBackend() {
        window.location = "/cashapp/action-point_of_sale.action_client_pos_menu";
    }
