...
from cashapp.tests import Form, tagged, new_test_user
from cashapp.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestCalendar(SavepointCaseWithUserDemo):
    ...
    def setUp(self):
        ...
        self.event_tech_presentation = self.CalendarEvent.create({
            ...
            'description': 'The Technical Presentation will cover following topics:\n* Creating CashApp class\n* Views\n* Wizards\n* Workflows',
            'duration': 2.5,
            'location': 'CashApp S.A.',
...
class TestCalendarTours(HttpCaseWithUserDemo):
    def test_calendar_month_view_start_hour_displayed(self):
        ...
        self.start_tour("/cashapp", 'calendar_appointments_hour_tour', login="demo")
    ...
    def test_calendar_delete_tour(self):
        ...
        url = "/cashapp/action-" + str(action_id.id)
