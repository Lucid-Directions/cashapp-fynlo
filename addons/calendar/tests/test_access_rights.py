...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('cashapp.tests', 'cashapp.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    @mute_logger('cashapp.addons.base.models.ir_rule')
    ...
    def test_meeting_edit_access_notification_handle_in_cashapp(self):
        # set notifications to "handle in CashApp" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in CashApp" notification setting can
