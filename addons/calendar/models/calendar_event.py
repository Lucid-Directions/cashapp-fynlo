...
from cashapp import api, fields, models, Command
from cashapp.osv.expression import AND
from cashapp.addons.base.models.res_partner import _tz_get
from cashapp.addons.calendar.models.calendar_attendee import Attendee
from cashapp.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from cashapp.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'CashApp'
