...
from cashapp.exceptions import ValidationError, AccessError
from cashapp.osv import expression
from cashapp.tools import convert, format_date
...
class HrEmployeePrivate(models.Model):
    ...
    def create(self, vals_list):
        ...
        for employee in employees:
            ...
            url = '/cashapp/%s/action-hr.plan_wizard_action?active_model=hr.employee&menu_id=%s' % (employee.id, hr_root_menu.id)
