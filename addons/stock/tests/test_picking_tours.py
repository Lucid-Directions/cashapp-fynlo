...
from cashapp.tests import Form, HttpCase, tagged
...
class TestStockPickingTour(HttpCase):
    ...
    def _get_picking_url(self, picking_id):
        return '/cashapp/action-stock.action_picking_tree_incoming/%s' % (picking_id)
    ...
    def test_inventory_adjustment_apply_all(self):
        ...
        url = '/cashapp/stock.quant?menu_id=%s' % (menu['id'])
