...
from cashapp import _, api, Command, fields, models
from cashapp.exceptions import UserError, ValidationError
from cashapp.osv import expression
from cashapp.tools.float_utils import float_compare, float_is_zero, float_round
from cashapp.tools.misc import clean_context, OrderedSet, groupby
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            if last_message and last_message.subject == msg_subject:
                continue
            cashappbot_id = self.env['ir.model.data']._xmlid_to_res_id("base.partner_root")
            doc.message_post(body=msg, author_id=cashappbot_id, subject=msg_subject)
