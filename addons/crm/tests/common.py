...
from cashapp.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from cashapp.addons.mail.tests.common import MailCase, mail_new_test_user
from cashapp.addons.phone_validation.tools import phone_validation
from cashapp.addons.sales_team.tests.common import TestSalesCommon
from cashapp.fields import Datetime
from cashapp import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('cashapp.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
