...
from cashapp.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('cashapp.models.unlink', 'cashapp.addons.crm.models.crm_team', 'cashapp.addons.crm.models.crm_team_member')
