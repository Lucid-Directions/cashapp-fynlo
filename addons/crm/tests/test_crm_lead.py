...
from cashapp.addons.base.tests.test_format_address_mixin import FormatAddressCase
from cashapp.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from cashapp.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from cashapp.addons.mail.tests.mail_tracking_duration_mixin_case import MailTrackingDurationMixinCase
from cashapp.addons.phone_validation.tools.phone_validation import phone_format
from cashapp.exceptions import UserError
from cashapp.tests import Form, tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    @mute_logger('cashapp.addons.mail.models.mail_thread')
