...
from cashapp.addons.mail.tools import mail_validation
from cashapp.addons.phone_validation.tools import phone_validation
from cashapp.exceptions import UserError, AccessError
from cashapp.osv import expression
from cashapp.tools.translate import _
from cashapp.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email, SQL
from cashapp.tools.misc import get_lang
...
PLS_COMPUTE_BATCH_STEP = 50000  # cashapp.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
