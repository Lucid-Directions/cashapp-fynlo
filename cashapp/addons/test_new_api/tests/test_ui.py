...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/cashapp/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@cashapp.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(cashapp.tests.HttpCase):

    @mute_logger('cashapp.sql_db', 'cashapp.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/cashapp/action-test_new_api.action_categories",
