...
from cashapp import _
from cashapp.exceptions import ValidationError, UserError
from cashapp.tools import mute_logger, SQL

_logger = logging.getLogger('cashapp.addons.base.partner.merge')
    ...
    def _update_foreign_keys_generic(self, model, src_records, dst_record):
        ...
        for table, column in relations:
            ...
            if len(columns) <= 1:
                ...
                try:
                    with mute_logger('cashapp.sql_db'), self._cr.savepoint():
