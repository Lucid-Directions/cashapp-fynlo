...
from cashapp.exceptions import MissingError, UserError
from cashapp.http import Stream, request
from cashapp.tools import file_open, replace_exceptions
from cashapp.tools.image import image_process, image_guess_size_from_field_name
from cashapp.tools.mimetypes import guess_mimetype, get_extension
from cashapp.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:cashapp.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~cashapp.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`cashapp.tools.image.image_process`.
