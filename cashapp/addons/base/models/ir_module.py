...
import cashapp
from cashapp import api, fields, models, modules, tools, _
from cashapp.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from cashapp.exceptions import AccessDenied, UserError, ValidationError
from cashapp.osv import expression
from cashapp.tools.parse_version import parse_version
from cashapp.tools.misc import topological_sort, get_flag
from cashapp.tools.translate import TranslationImporter, get_po_paths
from cashapp.http import request
from cashapp.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since CashApp 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since CashApp 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'CashApp Enterprise Edition License v1.0'),
        ('OPL-1', 'CashApp Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('CashApp Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("CashApp is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(cashapp.conf.server_wide_modules) & set(self.mapped('name'))
