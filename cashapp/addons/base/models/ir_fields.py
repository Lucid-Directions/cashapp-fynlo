...
from cashapp import api, Command, fields, models
from cashapp.tools import OrderedSet
from cashapp.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an cashapp
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`cashapp.osv.orm.Model.write` expects.

        :param model: :class:`cashapp.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`cashapp.fields.Field`
