...
BASE_VERSION = cashapp.modules.get_manifest('base')['version']
...
class ir_cron(models.Model):
    ...
    def _check_modules_state(cls, cr, jobs):
        ...
        # reset_module_states.
        cashapp.modules.reset_modules_state(cr.dbname)
    ...
    def _notifydb(self):
        ...
        """
        with cashapp.sql_db.db_connect('postgres').cursor() as cr:
