...
import cashapp
from cashapp import api, fields, models, tools, _, Command
from cashapp.exceptions import MissingError, ValidationError, AccessError, UserError
from cashapp.tools import frozendict
from cashapp.tools.safe_eval import safe_eval, test_python_expr
from cashapp.tools.float_utils import float_compare
...
class IrActionsServer(models.Model):
    ...
    Since CashApp 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': cashapp.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
