...
from cashapp import api, fields, models, tools, Command
from cashapp.exceptions import AccessError, UserError, ValidationError
from cashapp.osv import expression
from cashapp.tools import format_list, lazy_property, sql, unique, OrderedSet, SQL
from cashapp.tools.safe_eval import safe_eval, datetime, dateutil, time
from cashapp.tools.translate import _, LazyTranslate
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in cashapp.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by CashApp
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement CashApp many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by CashApp
