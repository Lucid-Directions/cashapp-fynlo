...
QWeb is the primary templating engine used by CashApp. It is an XML templating
...
<https://www.cashapp.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed cashapp user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` CashApp method from ``res.users`` model.
...
from cashapp import api, models, tools
from cashapp.modules import registry
from cashapp.tools import config, safe_eval, pycompat
from cashapp.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from cashapp.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from cashapp.tools.json import scriptsafe
from cashapp.tools.lru import LRU
from cashapp.tools.misc import str2bool
from cashapp.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from cashapp.http import request
from cashapp.tools.profiler import QwebTracker
from cashapp.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from cashapp.addons.base.models.assetsbundle import AssetsBundle
from cashapp.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since CashApp 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__cashappAssetError=1"
