...
import cashapp
from cashapp import api, http, models, tools, SUPERUSER_ID
from cashapp.exceptions import AccessDenied
from cashapp.http import request, Response, ROUTING_KEYS
from cashapp.modules.registry import Registry
from cashapp.service import security
from cashapp.tools.json import json_default
from cashapp.tools.misc import get_lang, submap
from cashapp.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and cashapp.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (cashapp.exceptions.AccessError, cashapp.exceptions.MissingError) as e:
                ...
                if isinstance(e, cashapp.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(cashapp.conf.server_wide_modules)
