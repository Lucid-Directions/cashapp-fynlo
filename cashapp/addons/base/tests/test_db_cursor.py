...
from cashapp.sql_db import db_connect, TestCursor
from cashapp.tests import common
from cashapp.tests.common import BaseCase, HttpCase
from cashapp.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = cashapp.api.Environment(self.cr, cashapp.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('cashapp.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:cashapp.sql_db:Found different un-closed cursor', msg)
