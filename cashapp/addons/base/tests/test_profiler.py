...
from cashapp.tests.common import BaseCase, TransactionCase, tagged, new_test_user
from cashapp.tools import profiler
from cashapp.tools.profiler import Profiler, ExecutionContext
from cashapp.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('cashapp.sql_db.db_connect', return_value=self.registry))
