...
from cashapp.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('cashapp.osv.expression'):
    ...
    def test_like_cast(self):
        ...
        with mute_logger('cashapp.sql_db'), self.assertRaises(psycopg2.Error):
