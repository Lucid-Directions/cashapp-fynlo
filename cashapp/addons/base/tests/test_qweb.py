...
from cashapp.addons.base.models.ir_qweb import QWebException, render
from cashapp.tools import misc, mute_logger
from cashapp.tools.json import scriptsafe as json_scriptsafe
from cashapp.exceptions import UserError, ValidationError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://cashapp.com/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/cashapp/sub">link</a>
                <a href="/link/cashapp/">link2</a>
            """
        values = {'url': 'cashapp', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('cashapp.addons.base.models.ir_qweb') # warning for template not found
