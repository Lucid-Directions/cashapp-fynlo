...
from cashapp.exceptions import AccessDenied, AccessError
from cashapp.http import _request_stack

import cashapp
import cashapp.tools
from cashapp.tests import common
from cashapp.service import common as auth, model
from cashapp.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   cashapp.api.model(lambda *_: collections.defaultdict(int)))
