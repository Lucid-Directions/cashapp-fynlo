...
@cashapp.tests.tagged('post_install', '-at_install', 'post_install_l10n')
class TestReports(cashapp.tests.TransactionCase):
...
class TestReportsRenderingCommon(cashapp.tests.HttpCase):
    ...
    def save_pdf(self):
        ...
        cashapp.tests.save_test_file(self._testMethodName, self.last_pdf_content, 'pdf_', 'pdf', document_type='Report PDF', logger=_logger)
...
@cashapp.tests.tagged('post_install', '-at_install', 'pdf_rendering')
...
@cashapp.tests.tagged('post_install', '-at_install', '-standard', 'pdf_rendering')
...
class TestAggregatePdfReports(cashapp.tests.HttpCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
