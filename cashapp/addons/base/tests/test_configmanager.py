...
import cashapp
from cashapp.tests import TransactionCase
from cashapp.tools import file_path, file_open, file_open_temporary_directory
from cashapp.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in cashapp.tools.config.options
ROOT_PATH = cashapp.tools.config.options['root_path'].removesuffix('/cashapp')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'addons_paths', cashapp.conf.addons_paths)
        self.patch(conf, 'server_wide_modules', cashapp.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/cashapp/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
            'pre_upgrade_scripts': '',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/cashapp',  # blacklist for save, ignored from the config file
    ...
    def test_04_cashapp16_config_file(self):
        # test that loading the CashApp 16.0 generated default config works
    ...
    def test_06_cli(self):
        ...
        values = {
            ...
            'log_handler': [
                ':INFO',
                'cashapp.tools.config:DEBUG',
                ':WARNING',
                'cashapp.http:DEBUG',
                'cashapp.sql_db:DEBUG',
            ],
            'log_db': 'logdb',
            'log_db_level': 'debug',
            'log_level': 'debug',
