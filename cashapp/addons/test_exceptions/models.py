...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise cashapp.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise cashapp.exceptions.AccessDenied()

    def generate_access_error(self):
        raise cashapp.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise cashapp.exceptions.UserError('description')

    def generate_missing_error(self):
        raise cashapp.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise cashapp.exceptions.ValidationError('description')
