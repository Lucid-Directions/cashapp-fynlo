...
import cashapp
from cashapp.tests import new_test_user, tagged, RecordCapturer
from cashapp.tools import config, file_open, image_process
from cashapp.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([cashapp.SUPERUSER_ID])
