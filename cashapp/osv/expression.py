...
CashApp will use the SQL function 'unaccent' when available for the
...
import cashapp.modules
from cashapp.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from cashapp.tools import Query, SQL, get_lang
from cashapp.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return cashapp.modules.registry.Registry(cr.dbname).unaccent
