...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/cashapp/cashapp/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # cashapp, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'cashapp_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~cashapp.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within cashapp, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within cashapp, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@cashapp.com
    * Output: "Admin" <notifications@cashapp.com>
    """
