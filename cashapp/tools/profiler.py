...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching CashApp.
    """
    name = 'traces_sync'
    ...
    def end(self):
        ...
        try:
            ...
            if self.db:
                ...
                from cashapp.sql_db import db_connect  # only import from cashapp if/when needed.
