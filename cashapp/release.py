...
description = 'CashApp Server'
long_desc = '''CashApp is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.cashapp.com'
author = 'OpenERP S.A.'
author_email = 'info@cashapp.com'
license = 'LGPL-3'

nt_service_name = "cashapp-server-" + series.replace('~','-')
