...
"""The CashApp API module defines CashApp Environments and method decorators.
...
from cashapp.tools.misc import StackMap

import typing
if typing.TYPE_CHECKING:
    from collections.abc import Callable
    from cashapp.sql_db import BaseCursor
...
def constrains(*args: str) -> Callable[[T], T]:
    ...
    Should raise :exc:`~cashapp.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~cashapp.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/cashapp/cashapp/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~cashapp.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~cashapp.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~cashapp.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~cashapp.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in cashapp.tools.file_open_temporary_directory)
