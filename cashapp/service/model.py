...
from cashapp.tools import DotDict, lazy
from cashapp.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(cashapp.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param cashapp.api.Environment env: The environment where the registry
