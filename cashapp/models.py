...
if typing.TYPE_CHECKING:
    ...
    from cashapp.api import Self, ValuesType, IdType
    ...
    def __new__(meta, name, bases, attrs):
        ...
        if attrs.get('_register', True):
            ...
            if '_module' not in attrs:
                ...
                assert module.startswith('cashapp.addons.'), \
                    f"Invalid import of {module}.{name}, it should start with 'cashapp.addons'."
...
class BaseModel(metaclass=MetaModel):
    """Base class for CashApp models.

    CashApp models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    the :attr:`~cashapp.models.BaseModel._register` attribute may be set to False.
    """
    ...
    If set to ``False``, override :meth:`~cashapp.models.BaseModel.init`
    ...
    .. tip:: To create a model without any table, inherit
            from :class:`~cashapp.models.AbstractModel`.
    """
    ...
    _module = None                      #: the model's module (in the CashApp sense)
    ...
    .. warning::
      ...
      :attr:`~cashapp.models.Model._inherits`-ed models, the inherited field will
    ...
    def load(self, fields, data):
        ...
        for field_path in fields:
            ...
            for field_name in field_path:
                ...
                if isinstance(model_fields.get(field_name), cashapp.fields.One2many):
    ...
    def _compute_display_name(self):
        ...
        it can be made field-dependent using :attr:`~cashapp.api.depends` and
        context-dependent using :attr:`~cashapp.api.depends_context`.
        """
        if self._rec_name:
        ...
        if field.type in ('datetime', 'date') or (field.type == 'properties' and granularity):
            ...
            if granularity == 'week':
                ...
                if granularity == 'day_of_week':
                    """
                    formula: ((7 - first_day_of_week_in_cashapp) + result_from_SQL) %  --> 0 based first day of week
                                    week start on
                                monday   sunday    sat
                                  1     |  7    |  6   <-- first day of week in cashapp
                           SQL | -----------------------
                    Monday  1  |  0     |  1    |  2
                    tuesday 2  |  1     |  2    |  3
                    wed     3  |  2     |  3    |  4
    ...
    def _read_group_fill_temporal(self, data, groupby, annoted_aggregates,
        ...
        if fill_from:
            fill_from = cashapp.fields.Datetime.to_datetime(fill_from) if isinstance(fill_from, datetime.datetime) else cashapp.fields.Date.to_date(fill_from)
        ...
        if fill_to:
            fill_to = cashapp.fields.Datetime.to_datetime(fill_to) if isinstance(fill_to, datetime.datetime) else cashapp.fields.Date.to_date(fill_to)
    ...
    def _field_to_sql(self, alias: str, fname: str, query: (Query | None) = None, flush: bool = True) -> SQL:
        ...
        result to make method :meth:`~cashapp.api.Environment.execute_query` flush
    ...
    def _check_company(self, fnames=None):
        ...
        :raises UserError: if the `company_id` of the value of any field is not
            ...
            :class:`~cashapp.addons.base.models.res_company`).

        For :class:`~cashapp.addons.base.models.res_users` relational fields,
    ...
    def write(self, vals: ValuesType) -> typing.Literal[True]:
        ...
        * For numeric fields (:class:`~cashapp.fields.Integer`,
          :class:`~cashapp.fields.Float`) the value should be of the
          corresponding type
        * For :class:`~cashapp.fields.Boolean`, the value should be a
          :class:`python:bool`
        * For :class:`~cashapp.fields.Selection`, the value should match the
          selection values (generally :class:`python:str`, sometimes
          :class:`python:int`)
        * For :class:`~cashapp.fields.Many2one`, the value should be the
          database identifier of the record to set
        * The expected value of a :class:`~cashapp.fields.One2many` or
          :class:`~cashapp.fields.Many2many` relational field is a list of
          :class:`~cashapp.fields.Command` that manipulate the relation the
          implement. There are a total of 7 commands:
          :meth:`~cashapp.fields.Command.create`,
          :meth:`~cashapp.fields.Command.update`,
          :meth:`~cashapp.fields.Command.delete`,
          :meth:`~cashapp.fields.Command.unlink`,
          :meth:`~cashapp.fields.Command.link`,
          :meth:`~cashapp.fields.Command.clear`, and
          :meth:`~cashapp.fields.Command.set`.
        * For :class:`~cashapp.fields.Date` and `~cashapp.fields.Datetime`,
          ...
          .. warning::
            ...
            :const:`cashapp.tools.misc.DEFAULT_SERVER_DATE_FORMAT` and
            :const:`cashapp.tools.misc.DEFAULT_SERVER_DATETIME_FORMAT`
    ...
    def ensure_one(self) -> Self:
        ...
        :raise cashapp.exceptions.ValueError: ``len(self) != 1``
        """
        try:
    ...
    def with_env(self, env: api.Environment) -> Self:
        ...
        :param env:
        :type env: :class:`~cashapp.api.Environment`
    ...
    def with_company(self, company) -> Self:
        ...
        :type company: :class:`~cashapp.addons.base.models.res_company` or int
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted CashApp models.

    CashApp models are created by inheriting from this class::
